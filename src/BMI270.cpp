...
int8_t BMI270::bmi2_i2c_read(uint8_t reg_addr, uint8_t *reg_data, uint32_t len, void *intf_ptr) {
    ...
    _i2c_ret = i2c_master_write_read_device(_dev_info->i2c_port, _dev_info->dev_addr, &reg_addr, 1, reg_data, len,
                                            portMAX_DELAY);
    if (_i2c_ret != ESP_OK) {
...
int8_t BMI270::bmi2_i2c_write(uint8_t reg_addr, const uint8_t *reg_data, uint32_t len, void *intf_ptr) {
    ...
    _i2c_ret =
        i2c_master_write_to_device(_dev_info->i2c_port, _dev_info->dev_addr, _data_buffer, (len + 1), portMAX_DELAY);
    if (_i2c_ret != ESP_OK) {
